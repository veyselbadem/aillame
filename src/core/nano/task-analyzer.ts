...
const TASK_KEYWORDS: Record<NanoTaskKind, readonly string[]> = {
  ...
  research: ["araştır", "kaynak", "literatür", "özetle", "bilgi", "rapor"],
  education: ["öğret", "ders", "öğrenci", "sınav", "quiz", "konu anlatımı", "ödev"],
  creative: ["hikaye", "metin yaz", "şiir", "senaryo", "tasarım", "yaratıcı", "reklam"],
