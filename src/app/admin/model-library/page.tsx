        ...
        {authorized === null ? (
          ...
          <div className="mx-auto max-w-5xl px-6 py-8">
            ...
            <div className="theme-surface rounded-xl p-5">
              <div className="mb-6">
                <h2 className="text-lg font-bold theme-title">Global Model Registry</h2>
                <p className="text-sm theme-muted">Tüm kayıtlı modellerin ve çalışma zamanı adaptörlerinin genel görünümü.</p>
              </div>
              <ModelLibraryPanel />
            </div>
