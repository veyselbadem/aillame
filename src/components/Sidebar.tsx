...
const ADMIN_NAV = [
  ...
  { href: '/admin/api-clients',         label: 'API İstemcileri',       icon: FiKey },
  { href: '/admin/agent-tasks',         label: 'Agent Görevleri',       icon: FiClipboard },
...
export default function Sidebar({ isOpen, setIsOpen }: SidebarProps) {
  ...
  return (
    <>
      ...
      <div
        className={`h-full w-64 flex flex-col transition-all duration-500 ${
      ...
      >
        ...
        <div className="px-5 py-5 flex items-center gap-3 border-b border-white/5">
          ...
          <div className="min-w-0">
            ...
            <p className="text-[9px] text-slate-500 dark:text-slate-400 font-bold uppercase tracking-[0.2em] mt-0.5">Core Alpha</p>
          </div>
          <button
            type="button"
        ...
        <div className="px-5 py-4 border-t border-slate-200 dark:border-white/5">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[9px] text-slate-600 dark:text-slate-400 font-black uppercase tracking-widest">Rust Core Active</span>
          </div>
          <p className="text-[8px] font-black tracking-[0.3em] text-slate-500 dark:text-slate-500 uppercase mt-1">AILLAME PROJECT v1.2</p>
        </div>
      </div>
